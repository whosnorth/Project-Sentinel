...
serve(async (req) => {
  ...
  try {
    ...
    // 1. TRIAGE ROUTER
    const triageModels = ["accounts/fireworks/models/deepseek-v3", "accounts/fireworks/models/qwen2p5-72b-instruct"];
...
Respond STRICTLY in JSON format matching this schema:
{
  ...
  "graph": {
    ...
    if (!triageResult.needs_heavy_extraction && triageResult.graph && triageResult.graph.nodes) {
      ...
      const heavyModels = ["accounts/fireworks/models/deepseek-v3", "accounts/fireworks/models/qwen2p5-72b-instruct"];
